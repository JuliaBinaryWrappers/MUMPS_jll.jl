...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MUMPS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ca64183c-ec4f-5579-95d5-17e128c21291"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MUMPS", artifacts_toml) for e in artifacts["MUMPS"]]
...
if best_platform === nothing
    @debug("Unable to load MUMPS; unsupported platform $(triplet(platform_key_abi()))")
else
