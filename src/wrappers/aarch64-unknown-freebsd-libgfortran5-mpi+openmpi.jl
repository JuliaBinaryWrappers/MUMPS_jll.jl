# Autogenerated wrapper script for MUMPS_jll for aarch64-unknown-freebsd-libgfortran5-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(LLVMOpenMP_jll, CompilerSupportLibraries_jll, METIS_jll, PARMETIS_jll, SCOTCH_jll, SCALAPACK32_jll, libblastrampoline_jll, OpenMPI_jll, MPIPreferences)
