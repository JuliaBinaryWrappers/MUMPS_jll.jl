# Autogenerated wrapper script for MUMPS_jll for armv7l-linux-musleabihf-libgfortran5-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, METIS_jll, PARMETIS_jll, SCOTCH_jll, SCALAPACK32_jll, libblastrampoline_jll, OpenMPI_jll, MPIPreferences)
