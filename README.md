# `MUMPS_jll.jl` (v5.8.1+0)

[![deps](https://juliahub.com/docs/MUMPS_jll/deps.svg)](https://juliahub.com/ui/Packages/General/MUMPS_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b24fb024f039f0e4ee0433aca024faca3cf30c10/M/MUMPS/MUMPS@5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://mumps-solver.org/MUMPS_5.8.1.tar.gz (SHA256 checksum: `e91b6dcd93597a34c0d433b862cf303835e1ea05f12af073b06c32f652f3edd8`)
