# `MUMPS_jll.jl` (v5.7.3+0)

[![deps](https://juliahub.com/docs/MUMPS_jll/deps.svg)](https://juliahub.com/ui/Packages/General/MUMPS_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/a46285237bda9065b5a28315752f16d202728418/M/MUMPS/MUMPS@5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://mumps-solver.org/MUMPS_5.7.3.tar.gz (SHA256 checksum: `84a47f7c4231b9efdf4d4f631a2cae2bdd9adeaabc088261d15af040143ed112`)
