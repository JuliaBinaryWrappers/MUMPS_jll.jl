# `MUMPS_jll.jl` (v5.4.2+1)

[![deps](https://juliahub.com/docs/MUMPS_jll/deps.svg)](https://juliahub.com/ui/Packages/MUMPS_jll/hnmvq?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0cccc4222d635815321517c0470306c2b09c3910/M/MUMPS/MUMPS@5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/0cccc4222d635815321517c0470306c2b09c3910/M/MUMPS/MUMPS@5/bundled)
